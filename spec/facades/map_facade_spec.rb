...
RSpec.describe 'Map Facade' do
    ...
    describe 'returns the route when inputting cities' do
        ...
        it "can return a route object from charlotte nc to galveston tx" do
            route = MapFacade.get_route("Charlotte, NC", "Galveston, TX")
        ...
        it 'can return a route object from nyc to monterrey, mexico' do
            route = MapFacade.get_route("NYC, new york", "Monterrey, Mexico")
        ...
        it 'can return a route object from nyc to monterrey, mexico' do
            route = MapFacade.get_route("boston, ma", "seattle, wa")
        ...
        it 'returns a route object from charlotte nc to london UK' do
            route = MapFacade.get_route("charlotte nc", "london UK")
        ...
        it 'returns a route object from charlotte nc to london UK' do
            route = MapFacade.get_route("beijing, china", "miami, fl")
